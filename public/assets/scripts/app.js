...
/***/ "../artifex-core/node_modules/@babel/runtime/regenerator/index.js":
/*!************************************************************************!*\
  !*** ../artifex-core/node_modules/@babel/runtime/regenerator/index.js ***!
  \************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {

module.exports = __webpack_require__(/*! regenerator-runtime */ "../artifex-core/node_modules/regenerator-runtime/runtime.js");


/***/ }),

/***/ "../artifex-core/node_modules/regenerator-runtime/runtime.js":
/*!*******************************************************************!*\
  !*** ../artifex-core/node_modules/regenerator-runtime/runtime.js ***!
  \*******************************************************************/
/***/ (function(module) {
...
/***/ "../artifex-core/scripts/assets.js":
/*!*****************************************!*\
  !*** ../artifex-core/scripts/assets.js ***!
  \*****************************************/
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "../artifex-core/node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./variables */ "../artifex-core/scripts/variables.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types */ "../artifex-core/scripts/types.js");
...
var _root = '';
var _load = {
  js: function js(path, conf) {
    return new Promise(function (resolve, reject) {
      var js = _variables__WEBPACK_IMPORTED_MODULE_1__._doc.createElement('script');
      ...
      _variables__WEBPACK_IMPORTED_MODULE_1__._doc.head.appendChild(js);
    });
  },
          ...
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", new Promise(function (resolve, reject) {
                var link = _variables__WEBPACK_IMPORTED_MODULE_1__._doc.createElement('link');
                ...
                _variables__WEBPACK_IMPORTED_MODULE_1__._doc.head.appendChild(link);
              }));
...
var assets = {
  ...
  root: function root(value) {
    if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.$isString)(value)) {
      _root = value;
    }
  ...
  load: function load(options) {
    var files = (0,_types__WEBPACK_IMPORTED_MODULE_2__.$toArray)(options.files);
    var root = options.root !== _variables__WEBPACK_IMPORTED_MODULE_1__.U ? options.root : this.root();
    var js = (0,_types__WEBPACK_IMPORTED_MODULE_2__.$toArray)(options.scripts);
    var css = (0,_types__WEBPACK_IMPORTED_MODULE_2__.$toArray)(options.styles);
    var img = (0,_types__WEBPACK_IMPORTED_MODULE_2__.$toArray)(options.images);
    var assets = {};
    var i = 0;
    var type; // Determine file type

    for (; i < files.length; i++) {
      var ext = files[i].split('.').pop().split(/#|\?/)[0];
      type = ext === 'js' || ext === 'css' ? ext : /(gif|jpe?g|png|svg|webp)$/i.test(ext) ? 'img' : '';
    ...
    var promises = [];
    Object.keys(assets).forEach( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(asset) {
        var noCache, a, file;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                a = _variables__WEBPACK_IMPORTED_MODULE_1__._doc.createElement('a');
                type = assets[asset];
                a.href = (root && /^(https?:)?\/\//i.test(asset) ? '' : root) + asset;
                file = a.href;
  ...
  remove: function remove(f) {
    ...
    var files = (0,_types__WEBPACK_IMPORTED_MODULE_2__.$toArray)(f);

    var a = _variables__WEBPACK_IMPORTED_MODULE_1__._doc.createElement('a');
    ...
    for (; i < files.length; i++) {
      ...
      if (el !== _variables__WEBPACK_IMPORTED_MODULE_1__.U) {
...
/* harmony export */ });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "../artifex-core/scripts/types.js");
...
function $exec(fn) {
  ...
  var fns = (0,_types__WEBPACK_IMPORTED_MODULE_0__.$toArray)(fn);
  var len = fns.length;
  var i = 0;
  var response;

  for (; i < len; i++) {
    var conf = (0,_types__WEBPACK_IMPORTED_MODULE_0__._extend)({
      args: []
    }, options);

    response = fns[i].apply(conf.scope, (0,_types__WEBPACK_IMPORTED_MODULE_0__.$toArray)(conf.args));
...
/***/ "../artifex-core/scripts/createRouteHandler.js":
/*!*****************************************************!*\
  !*** ../artifex-core/scripts/createRouteHandler.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (uses) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "_slice": function() { return /* binding */ _slice; },
/* harmony export */   "_castString": function() { return /* binding */ _castString; },
/* harmony export */   "_copy": function() { return /* binding */ _copy; },
/* harmony export */   "_extend": function() { return /* binding */ _extend; },
/* harmony export */   "_equals": function() { return /* binding */ _equals; },
...
/* harmony export */   "$unserialize": function() { return /* binding */ $unserialize; }
/* harmony export */ });
...
function $extend(deep) {
  ...
  var args = _slice.call(arguments).slice(bool ? 1 : 0);
...
function $serialize(obj) {
  ...
  Object.keys(obj || {}).forEach(function (key) {
    ...
    if (_typeof(val) !== 'object') {
      arr.push("".concat(key, "=").concat(encodeURIComponent(val)));
    } else if (Array.isArray(val)) {
      val.forEach(function (el) {
        arr.push("".concat(key, "[]=").concat(encodeURIComponent(el)));
      });
    }
  });
...
/***/ "../artifex-core/scripts/variables.js":
/*!********************************************!*\
  !*** ../artifex-core/scripts/variables.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "_doc": function() { return /* binding */ _doc; },
/* harmony export */   "_body": function() { return /* binding */ _body; },
/* harmony export */   "_html": function() { return /* binding */ _html; },
/* harmony export */   "_win": function() { return /* binding */ _win; },
/* harmony export */   "U": function() { return /* binding */ U; }
/* harmony export */ });
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core */ "../artifex-core/scripts/core.js");
/* eslint-disable */

var D = _core__WEBPACK_IMPORTED_MODULE_0__.isBrowser ? window.document : {};
var scope = _core__WEBPACK_IMPORTED_MODULE_0__.isBrowser ? window : __webpack_require__.g; // Export globals for use in other modules
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var artifex_core_scripts_assets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! artifex-core/scripts/assets */ "../artifex-core/scripts/assets.js");
/* harmony import */ var artifex_core_scripts_createRouteHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! artifex-core/scripts/createRouteHandler */ "../artifex-core/scripts/createRouteHandler.js");
...
/* harmony default export */ __webpack_exports__["default"] = ((0,artifex_core_scripts_createRouteHandler__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          artifex_core_scripts_assets__WEBPACK_IMPORTED_MODULE_1__["default"].load({
            root: 'https://cdnjs.cloudflare.com/ajax/libs',
            files: ['/mapbox-gl/1.13.2/mapbox-gl.js', '/hover.css/2.3.1/css/hover-min.css']
          }).then(function () {
            console.log('test');
          }).catch(function (err) {
            console.log('err', err);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var artifex_core_scripts_createRouteHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! artifex-core/scripts/createRouteHandler */ "../artifex-core/scripts/createRouteHandler.js");

/* harmony default export */ __webpack_exports__["default"] = ((0,artifex_core_scripts_createRouteHandler__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {//
}));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkartifex"] = self["webpackChunkartifex"] || [];
